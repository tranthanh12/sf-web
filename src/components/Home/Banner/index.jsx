            ...
            <div className="slider" bis_skin_checked={1}>
                <div className="swiper-container page-banner-slider swiper-container-fade swiper-container-initialized swiper-container-horizontal" style={{ cursor: 'grab' }} bis_skin_checked={1}>
                    <div className="swiper-wrapper" id="swiper-wrapper-99dce5c0a52df8da" aria-live="off" style={{ transitionDuration: '0ms' }} bis_skin_checked={1}>
                        <div className="swiper-slide slides__item swiper-slide-duplicate" style={{ backgroundImage: './images/banner/Group 8.png")', width: '1860px', transitionDuration: '0ms', opacity: 0, transform: 'translate3d(0px, 0px, 0px)' }} data-swiper-slide-index={4} role="group" aria-label="1 / 7" bis_skin_checked={1}>
                        ...
                        <div className="swiper-slide slides__item" style={{ backgroundImage: 'url("./images/banner/Group 8.png")', width: '1860px', transitionDuration: '0ms', opacity: 0, transform: 'translate3d(-1860px, 0px, 0px)' }} data-swiper-slide-index={0} role="group" aria-label="2 / 7" bis_skin_checked={1}>
                            <div className="container" bis_skin_checked={1}>
                        ...
                        <div className="swiper-slide slides__item swiper-slide-prev" style={{ backgroundImage: 'url("./images/banner/Group 8.png")', width: '1860px', transitionDuration: '0ms', opacity: 0, transform: 'translate3d(-3720px, 0px, 0px)' }} data-swiper-slide-index={1} role="group" aria-label="3 / 7" bis_skin_checked={1}>
                            <div className="container" bis_skin_checked={1}>
                                <div className="title" bis_skin_checked={1}>Mobile Application Development</div>
                        ...
                        <div className="swiper-slide slides__item swiper-slide-active" style={{ backgroundImage: 'url("./images/banner/Group 8.png")', width: '1860px', transitionDuration: '0ms', opacity: 1, transform: 'translate3d(-5580px, 0px, 0px)' }} data-swiper-slide-index={2} role="group" aria-label="4 / 7" bis_skin_checked={1}>
                            <div className="container" bis_skin_checked={1}>
                                <div className="title" bis_skin_checked={1}>Mobile Application Development</div>
                        ...
                        <div className="swiper-slide slides__item swiper-slide-next" style={{ backgroundImage: 'url("./images/banner/Group 8.png")', width: '1860px', transitionDuration: '0ms', opacity: 0, transform: 'translate3d(-7440px, 0px, 0px)' }} data-swiper-slide-index={3} role="group" aria-label="5 / 7" bis_skin_checked={1}>
                            <div className="container" bis_skin_checked={1}>
                        ...
                        <div className="swiper-slide slides__item" style={{ backgroundImage: 'url("https://ntq.com.vn/media/KcgPxlsT9yQmPTgBJvcA")', width: '1860px', transitionDuration: '0ms', opacity: 0, transform: 'translate3d(-9300px, 0px, 0px)' }} data-swiper-slide-index={4} role="group" aria-label="6 / 7" bis_skin_checked={1}>
                            <div className="container" bis_skin_checked={1}>
                                <div className="title" bis_skin_checked={1}>Mobile Application Development</div>
                                <div className="subtitle" bis_skin_checked={1}>The world is becoming more mobile. Why not
                                    profiting from this trend to develop your business idea? Tell us your story, we will
                ...
                <div className="swiper-pagination page-banner-slider-pagination swiper-pagination-clickable swiper-pagination-bullets" bis_skin_checked={1}>
                    <span onClick={()=>{setIndexBanner(1)}} className="swiper-pagination-bullet" tabIndex={0} role="button" aria-label="Go to slide 1" />
